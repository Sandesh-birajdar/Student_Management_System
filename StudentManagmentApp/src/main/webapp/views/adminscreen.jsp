		...
		<ul class="nav nav-pills ms-auto">
			<li class="nav-item">
				<button class="nav-link active" data-bs-toggle="pill"
					data-bs-target="#registerTab">Register Student</button>
			</li>
			<li class="nav-item">
				<button class="nav-link" data-bs-toggle="pill"
					data-bs-target="#viewTab">Student Details</button>
			</li>
					...
					<div class="card enroll p-4 shadow">
						...
						<form action="enroll_student" method="post">
							<div class="row g-3">
								...
								<div class="col-md-6">
									<label>Full Name</label> <input type="text"
										class="form-control" name="studentFullName" required>
								</div>
								...
								<div class="col-md-6">
									<label>Fees Paid</label> <input type="number"
										class="form-control" name="feesPaid">
								</div>

								<div class="col-md-6">
									<label>Course</label><br> <input type="radio"
										name="studentCourse" value="Java" checked> Java <input
										type="radio" name="studentCourse" value="Python" class="ms-3">
									Python <input type="radio" name="studentCourse" value="Testing"
										class="ms-3"> Testing
								</div>

								<div class="col-md-6">
									<label>Batch Mode</label> <select class="form-select"
										name="batchMode">
							...
							<div class="text-center mt-4">
								<button class="btn btn-custom btn-lg px-5">Register
									Student</button>
							</div>
						</form>
					</div>
					...
					<tbody>
						<c:forEach items="${data}" var="s">
							<tr>
								...
								<td>₹ ${s.feesPaid}</td>
								<td>
									<a class="btn btn-success btn-sm" href="fees?id=${s.studentId}">Pay Fees</a>
									<a class="btn btn-primary btn-sm" href="batch?id=${s.studentId}">Shift Batch</a> 
									<a href="delete?studentId=${s.studentId}" class="btn btn-danger btn-sm">Remove</a>
								</td>
							</tr>
						</c:forEach>
					</tbody>
